...
-- 3. Move helper functions to private schema to prevent RPC access
...
-- 5. Update RLS policies to use private functions

-- Update household_members policies
...
-- Update household_invitations policies
...
-- 6. Restrict RPC access to operational functions - only authenticated users
