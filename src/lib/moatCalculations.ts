...
export const MOAT_MILESTONES: Record<number, MoatMilestone> = {
  25: {
    ...
    message: "You're building on solid ground.",
    icon: "🧱",
  ...
  50: {
    percentage: 50,
    title: "Halfway Point",
    message: "Discipline today creates security tomorrow.",
    icon: "⚖️",
  ...
  75: {
    percentage: 75,
    title: "Nearly There",
    message: "True power is being ready for the unexpected.",
    icon: "🛡️",
    celebrationLevel: 'milestone',
  },
  100: {
    percentage: 100,
    title: "Fund Complete",
    message: "You now have a foundation of security.",
    icon: "✨",
