-- Phase 1: Critical database hardening (complete fix)
...
-- 3. Drop ALL existing policies first (including the one we missed)
...
-- 6. Recreate ALL RLS policies using private functions
