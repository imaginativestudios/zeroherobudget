          ...
          <div className="w-[280px] sm:w-[400px] lg:w-[520px] h-[175px] sm:h-[250px] lg:h-[325px] bg-background rounded overflow-hidden">
            ...
            <div className="h-full flex">
              ...
              <div className="w-12 lg:w-16 bg-primary flex flex-col items-center py-2 lg:py-3 gap-2">
                <svg 
                  viewBox="270 15 105 80" 
                  className="w-6 h-6 lg:w-8 lg:h-8"
                >
                  {/* Slash line */}
                  <line 
                    x1="294.37" y1="82.51" x2="341.63" y2="24.42" 
                    stroke="#F4A259" 
                    strokeWidth="7" 
                    strokeLinecap="round"
                    strokeMiterlimit="10"
                  ...
                  <path 
                    fill="#F4A259"
                    d="M361.44,54.89c0,7.26-1.12,13.68-3.36,19.27c-2.24,5.59-5.4,10.29-9.48,14.11c-4.08,3.82-8.91,6.73-14.49,8.72
                      c-5.59,2-11.71,2.99-18.38,2.99c-6.67,0-12.79-1-18.38-2.99c-5.58-2-10.42-4.9-14.49-8.72c-4.08-3.82-7.24-8.52-9.48-14.11
                      c-2.24-5.59-3.36-12.01-3.36-19.27c0-7.26,1.12-13.68,3.36-19.27c2.24-5.59,5.4-10.3,9.48-14.11c4.08-3.82,8.91-6.73,14.49-8.72
                      c5.59-2,11.71-2.99,18.38-2.99c6.67,0,12.8,1,18.38,2.99c5.58,2,10.41,4.9,14.49,8.72c4.08,3.82,7.24,8.52,9.48,14.11
                      C360.32,41.21,361.44,47.63,361.44,54.89z M345.83,54.89c0-4.76-0.66-9.08-1.96-12.95c-1.31-3.87-3.2-7.18-5.66-9.93
                      c-2.47-2.75-5.48-4.88-9.03-6.38c-3.55-1.5-7.54-2.24-11.97-2.24c-4.38,0-8.32,0.75-11.82,2.24c-3.5,1.5-6.49,3.62-8.95,6.38
                      c-2.47,2.75-4.36,6.06-5.66,9.93c-1.31,3.87-1.96,8.19-1.96,12.95s0.65,9.08,1.96,12.95c1.31,3.87,3.2,7.18,5.66,9.93
                      c2.47,2.75,5.45,4.88,8.95,6.38c3.5,1.5,7.44,2.24,11.82,2.24c4.43,0,8.42-0.75,11.97-2.24c3.55-1.5,6.57-3.62,9.03-6.38
                      c2.47-2.75,4.36-6.06,5.66-9.93C345.17,63.97,345.83,59.65,345.83,54.89z"
                  />
                </svg>
